// Rutas relacionadas con el "simulacro" (migración y consultas)
// - Aquí se exponen endpoints que usan PostgreSQL y MongoDB según convenga
...
router.post('/migrate', async (req, res) => {
    try {
        const csvPath = path.join(__dirname, '../../data/simulacro_saludplus_data.csv');
